...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h3b9399c37be779ac: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h450f6263beb51b49: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h540db4346f0c135b: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h2d4fec0a452cd065: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h06abf3caf9a8770c: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h2ecb553bc665ecb9: (a: number, b: number) => void;
